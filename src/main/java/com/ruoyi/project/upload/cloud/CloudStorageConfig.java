...
import com.ruoyi.project.upload.cloud.valdator.AliyunGroup;
import com.ruoyi.project.upload.cloud.valdator.QcloudGroup;
import com.ruoyi.project.upload.cloud.valdator.QiniuGroup;
...
public class CloudStorageConfig implements Serializable {
    ...
    public String getQiniuEntity() {
        return qiniuEntity;
    }

    public void setQiniuEntity(String qiniuEntity) {
    ...
    public String getAliyunEntity() {
        return aliyunEntity;
    }

    public void setAliyunEntity(String aliyunEntity) {
        this.aliyunEntity = aliyunEntity;
    }
    ...
    public String getQcloudEntity() {
        return qcloudEntity;
    }

    public void setQcloudEntity(String qcloudEntity) {
        this.qcloudEntity = qcloudEntity;
    }
